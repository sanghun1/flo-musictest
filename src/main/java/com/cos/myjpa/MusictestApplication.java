...
public class MusictestApplication {
	...
	////////////////////////////////////////////////////////////////////////////////////////////////
		...
		String ballade_lyrics20 = "언제부턴가 불쑥\n" // 산들 - 취기를 빌려 (취향저격 그녀 X 산들)
				+"내 습관이 돼버린 너\n"
				+"혹시나 이런 맘이\n"
				+"어쩌면 부담일까\n"
				+"널 주저했어\n"
		...
		String ballade_lyrics21 = "Breeze\n" // 폴킴 - 커피한잔할래요
		...
		String ballade_lyrics22 = "꿈에서도 그리운 목소리는\n" // IU (아이유) - 이름에게
				+"이름 불러도 대답을 하지 않아\n"
				+"글썽이는 그 메아리만 돌아와\n"
				+"그 소리를 나 혼자서 들어\n"
				+"깨어질 듯이 차가워도\n"
		...
		String ballade_lyrics23 = "널 품기 전 알지 못했다\n" // 에일리 - 첫눈처럼 너에게 가겠다IU (아이유)
				+"내 머문 세상 이토록\n"
				+"찬란한 것을\n"
				+"작은 숨결로 닿은 사람\n"
				+"겁 없이 나를 불러준 사랑\n"
		...
		String ballade_lyrics24 = "기다리지 않기로 했잖아\n" // IU (아이유) - 자장가
				+"울지 않을 거라고 그랬잖아\n"
				+"너무 늦은 밤이야\n"
				+"오 너무 긴 이별이야\n"
                +"\n"
		...
		String ballade_lyrics25 = "안녕이라고 되뇌어보지만\n" // 헤이즈 (Heize) - 다 그렇지 뭐
				+"갈 곳 잃은 바람 같아서\n"
				+"멀리 가지도 못하고 맴돌아\n"
				+"항상 그 자리로 돌아와\n"
				+"혹시 나를 배려하는 거라면\n"
		...
		String pop_lyrics9 = "Ye this song is my love story\n" // IU (아이유) - 있잖아 (FEAT.마리오)
				+"첫 눈에 반한다는 말\n"
				+"절대로 믿지 않던 난\n"
				+"내 앞에 너 나타난 순간\n"
				+"뺏겨버린 맘 멈춰버린 시간\n"
		...
		return (args) -> {
			...
			songRepository.saveAll(Arrays.asList(
					...
					new Song(null, "취기를 빌려 (취향저격 그녀 X 산들)", "산들", CategoryType.BALLADE, ballade_lyrics20, "2020. 07", "산들 - 취기를 빌려 (취향저격 그녀 X 산들).jpg", "산들 - 취기를 빌려 (취향저격 그녀 X 산들).mp3"),
					new Song(null, "커피한잔할래요", "폴킴", CategoryType.BALLADE, ballade_lyrics21, "2019. 07", "폴킴 - 커피한잔할래요.jpg", "폴킴 - 커피한잔할래요.mp3"),
					new Song(null, "이름에게", "IU (아이유)", CategoryType.BALLADE, ballade_lyrics22, "2017. 04", "IU (아이유) - 팔레트.jpg", "IU (아이유) - 이름에게.mp3"),
					new Song(null, "첫눈처럼 너에게 가겠다", "에일리", CategoryType.BALLADE, ballade_lyrics23, "2017. 01", "에일리 - 첫눈처럼 너에게 가겠다.jpg", "에일리 - 첫눈처럼 너에게 가겠다.mp3"),
					new Song(null, "자장가", "IU (아이유)", CategoryType.BALLADE, ballade_lyrics24, "2019. 11", "IU (아이유) - Love poem.jpg", "IU (아이유) - 자장가.mp3"),
					new Song(null, "다 그렇지 뭐", "헤이즈 (Heize)", CategoryType.BALLADE, ballade_lyrics25, "2020. 02", "헤이즈 (Heize) - 다 그렇지 뭐.", "헤이즈 (Heize) - 다 그렇지 뭐.mp3"),
